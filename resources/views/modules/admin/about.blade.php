    ...
    <div class="col-md-12">
      <div class="col-md-12">
        <div class="form-group">
         ...
         <input type="text" name="mod[{{$num}}][about][title][{{ $lang->code }}][]" 
         value="{{ $data == null ? 'من نحن؟' : getDataContent($data, 'title', $lang->code) }}" class="form-control">
     ...
     <div class="col-md-12">
      <div class="form-group">
       ...
       <textarea class="form-control ckeditor editor-ajax" id="mod-content-{{ $lang->code . '-' . rand(0,99999888)}}" rows="5" name="mod[{{$num}}][about][desc][{{ $lang->code }}][]">{{ $data == null ? '' : getDataContent($data, 'desc', $lang->code) }}</textarea>
