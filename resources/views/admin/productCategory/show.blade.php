		...
		<div class="col-xs-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">
						{{ trans('admin.product-categories') }}
					</h4>
					<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
					<div class="heading-elements">
						<ul class="list-inline mb-0">
							<li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
							{!! getCreateBtn(route('product-categories.create'), 'product-categories.create') !!}

							{!! getDeleteBtn(route('admin.product-categories.deletes'), 'product-categories.delete') !!}
				...
				<div class="card-body collapse in">
					<div class="card-block card-dashboard">
							...
							<div role="tabpanel" class="tab-pane fade {{ $key == 0 ? 'active in' : '' }}" id="{{ $lang->code  }}" aria-labelledby="{{ $lang->code }}-tab" aria-expanded="{{ $key == 0 ? 'true' : 'false' }}">
								...
								<table class="table table-striped table-bordered">
									...
									<tr>
										...
										<td>{{ $product->langWith($lang->code)->title }}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>{!! getStatus($product->show, $lang->code) !!}</td>
									</tr>
						...
						<a href="{{ route('product-categories.index') }}" class="btn btn-danger">{{ trans('admin.back') }}</a>
					</div>
				</div>
