                    ...
                    <div class="card-block card-dashboard">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! getAjaxAction('menus.', $menu, route('menu.show', $menu->id), route('menu.edit', $menu->id), route('menu.destroy', $menu->id)) !!}
                                    @if($menu->has_parent)
                                    <a href="{{ route('menu.parent.list', $menu->id) }}" class="btn btn-warning btn-circle">
