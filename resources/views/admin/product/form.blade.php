...
<div class="col-md-12">
    <div class="form-group">
     <label for="title">{{ trans('admin.price') }}</label>
 ...
 <div class="col-md-12">
    <div class="form-group">
     <label for="title">{{ trans('admin.brand') }}</label>
...
<div class="col-md-12">
 <div class="form-group">
  ...
  {!! Form::text('image[0][image]', getImageValue($product, 'image'), 
  array('class'=>'form-control', 'id' => '')) !!}
</div>

@if($product != null)
<img style="margin-top:15px;max-width: 150px;max-height:150px;" src="{{ $product->image_path }}">
@endif
...
<div class="meta-image-content" style="display: none;">
  ...
  <div class="form-group">
   ...
   <div class="input-group">
     {!! Form::text('image[0][title]['.$lang->code.']',getImageValue($product, 'title', $lang->code), 
